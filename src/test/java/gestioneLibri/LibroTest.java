...
public class LibroTest {
    ...
    public void testEquals() {
        ...
        //Stesso ISBN
        Libro uguale = new Libro( "Titolo Diverso", "Autore Diverso", 2020, libroDiProva.getIsbn(), 9);
        assertTrue(libroDiProva.equals(uguale));

        //ISBN diverso)
        Libro diverso = new Libro(libroDiProva.getTitolo(), libroDiProva.getAutore(), libroDiProva.getAnnoPubblicazione(), "0000000000000", libroDiProva.getCopieDisponibili());
        assertFalse(libroDiProva.equals(diverso));
    }
    ...
    public void testHashCode() {
        ...
        //ISBN diverso
        Libro libroDiverso = new Libro(libroDiProva.getTitolo(), libroDiProva.getAutore(), libroDiProva.getAnnoPubblicazione(), "0000000000000", libroDiProva.getCopieDisponibili());
