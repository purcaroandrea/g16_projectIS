...
public class ArchivioLibriTest {
    ...
    public void testModificaLibroSuccesso() {
        ...
        Libro modificato = new Libro("La Divina Commedia-Edizione Speciale", "Mondadori", 2025, "9788804671657", 10);
    ...
    public void testModificaLibroNonEsistente() {
        ...
        Libro inesistente = new Libro("Inesistente", "Nessuno", 0000, "0000000000000", 0);
        assertThrows(NoSuchElementException.class, () -> {
            archivio.modificaLibro(inesistente);
        });
    }
    ...
    public void testRimuoviLibroNonEsistente() {
        ...
        Libro inesistente = new Libro("Inesistente", "Nessuno", 0000, "0000000000000", 0);
        assertThrows(NoSuchElementException.class, () -> {
            archivio.rimuoviLibro(inesistente);
        });
    }
    ...
    public void testCercaPerIsbnNonEsistente() {
        ...
        Libro inesistente = archivio.cercaPerIsbn("0000000000000");
        assertNull(inesistente);
    }
