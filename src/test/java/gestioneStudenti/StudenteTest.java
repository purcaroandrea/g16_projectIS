...
@Test 
    public void testCostruttoreAndGetters() {
        ssertEquals(NOME_INIZIALE, studenteBase.getNome(), "Il nome non corrisponde a quello atteso.");
...
@Test
    public void testSortingList() {
        ...
        Studente s3 = new Studente("Carlo", "Rossi", "C22222", "c@c.it"); 	ArrayList<Studente> listaNonOrdinata = new ArrayList<>();
