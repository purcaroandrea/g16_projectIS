...
public void testAggiungiStudenteMatricolaDuplicata() {
        ...
        Studente s_duplicato = new Studente("A100", "Nome", "Cognome", 	"mail@mail.it");
	assertThrows(IllegalArgumentException.class, () -> {
            archivio.aggiungiStudente(s_duplicato);
...
public void testModificaStudenteSuccesso() {
    	Studente s1_modificato = new Studente("A100", "Marco", "Gialli", 	"marco.g@mail.it");
        archivio.modificaStudente(s1_modificato);
...
public void testModificaStudenteNonTrovato() {
        Studente s_non_esistente = new Studente("Z999", "Nome", "Cognome", 	"mail@mail.it");
        
       assertThrows(IllegalStateException.class, () -> {
       archivio.modificaStudente(s_non_esistente);
...
public void testRimuoviStudenteNonTrovato() {
        ...
        assertThrows(IllegalStateException.class, () -> {
            archivio.rimuoviStudente(s_non_esistente);
...
public void testCercaPerCognomeParziale() {
        Studente s_parziale = new Studente("D400", "Paolo", "Marossi", 	"p.m@mail.it");
        archivio.aggiungiStudente(s_parziale);
