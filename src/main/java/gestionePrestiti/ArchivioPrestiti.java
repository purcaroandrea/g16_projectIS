 ...
 * @brief La classe gestisce l'archivio dei prestiti dei libri ai relativi studenti.
 *
 * La classe permette di registrare prestiti e restituzioni,
...
public class ArchivioPrestiti {
    /**
     * @brief Mappa che associa a ciascuno studente la lista dei suoi prestiti attivi.
     * La chiave è la matricola dello studente.
     */
     ...
     * @return Prestito L’oggetto Prestito creato, altrimenti null se il prestito non può essere effettuato.
     ...
     * @post Il libro risulta restituito, le copie disponibili aggiornate
